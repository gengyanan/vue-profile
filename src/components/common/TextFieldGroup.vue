<template>
  <div class="create-form ">
    <el-form :model="createForm" :rules="rules" ref="createForm">
      ...
      <el-form-item>
        <el-select clearable placeholder="请选择" v-model="createForm.status">
          <el-option
            :key="item.value"
            :label="item.label"
            :value="item.value"
      ...
      <el-form-item prop="githubusername">
      ...
      <div class="add-group">
        ...
        <div class="infogroup" v-if="show">
          <div class="mt-20">
            <el-input placeholder="微信公众号" v-model="createForm.wechat">
          ...
          <div class="mt-20">
            <el-input placeholder="腾讯课堂网址" v-model="createForm.tengxunkt">
              <i
          ...
          <div class="mt-20">
            <el-input placeholder="网易课堂网址" v-model="createForm.wangyikt">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        handle: [
          { required: true, trigger: "blur", message: "handle不能为空!" }
        ],
        status: [
